...
Парящая панель: короткая пилюля по центру экрана, оторванная от нижнего края. Готовое сочетание, а не один параметр — длина 60%, отступы 12/10, скругление 16 px, градиенты сняты, блюр выключен.
